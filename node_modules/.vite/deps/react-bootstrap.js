...
var Switch = React69.forwardRef((props, ref) => (0, import_jsx_runtime66.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var NavItem = React75.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime72.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React76.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime73.jsx)(SelectableContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime73.jsx)(NavContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime73.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
var ModalHeader = React82.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React83.forwardRef(({
  className,
  bsPrefix,
...
var Modal = React84.forwardRef(({
  ...
  const renderBackdrop = (0, import_react43.useCallback)((backdropProps) => (0, import_jsx_runtime81.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React85.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React86.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime83.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames65.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React87.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  return (0, import_jsx_runtime84.jsx)(Nav_default, {
    ...
    ref,
    activeKey,
    className: (0, import_classnames66.default)(className, {
      [bsPrefix]: !isNavbar,
...
var PopoverHeader = React90.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React91.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React93.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Tooltip = React94.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react47.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime95.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react49.cloneElement)(children, triggerProps), (0, import_jsx_runtime94.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var TabContent = React110.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Table = React112.forwardRef(({
  ...
  const table = (0, import_jsx_runtime114.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime115.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime115.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime116.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime115.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime115.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime115.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React114.forwardRef((props, ref) => (0, import_jsx_runtime117.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React116.forwardRef(({
  ...
  return (0, import_jsx_runtime119.jsxs)("div", {
    ...
    children: [children, closeButton && (0, import_jsx_runtime118.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React117.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
