...
function getReactVersion() {
  const parts = React11.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var RTGTransition = React12.forwardRef((_ref, ref) => {
  let {
    component: Component
...
var OffcanvasBody = React16.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React17.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
...
var AbstractModalHeader = React20.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context2 = (0, import_react26.useContext)(ModalContext_default);
...
var OffcanvasHeader = React21.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var divWithClassName_default = (className) => React22.forwardRef((p, ref) => (0, import_jsx_runtime16.jsx)("div", {
  ...p,
  ref,
...
var OffcanvasTitle = React23.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React24.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react27.useCallback)((backdropProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React25.forwardRef((props, ref) => {
  const context2 = (0, import_react28.useContext)(NavbarContext_default);
...
var NavbarText = React26.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React27.forwardRef((props, ref) => {
  const {
...
//# sourceMappingURL=chunk-NQJK4Z2K.js.map
